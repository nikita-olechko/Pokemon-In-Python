def starter_pokemon_dict() -> dict:
    starter_dict = {
        ...
        'ivysaur': {'Evolution-One': 'Bulbasaur', 'Evolution-Two': 'Ivysaur', 'Evolution-Three': 'Venusaur',
                    ...
                    'Move-Three': 'Earthquake', 'Move-Four': '', 'Location': 'Ocean'},
        'venusaur': {'Evolution-One': 'Bulbasaur', 'Evolution-Two': 'Ivysaur', 'Evolution-Three': 'Venusaur',
                     ...
                     'Move-Three': 'Earthquake', 'Move-Four': 'Hyper Beam', 'Location': 'Ocean'},
...
def forest_pokemon() -> dict:
    forest_dict = {
        ...
        'dugtrio': {'Evolution-One': 'Diglett', 'Evolution-Two': 'Dugtrio', 'Evolution-Three': '', 'Class': 'Mine',
                    ...
                    'Location': 'Forest'},
        'arceus': {'Evolution-One': 'Arceus', 'Class': 'Legendary', 'Current HP': 400, 'Move-One': 'Judgment',
                   'Move-Two': 'Recover', 'Move-Three': 'Hyper Beam', 'Move-Four': 'Earthquake', 'Location': 'Forest'}}
    return forest_dict
...
standardize_location(mine_pokemon())
