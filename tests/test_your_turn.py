...
from combat.combat import your_turn


class TestYourTurn(TestCase):
    def test_TypeError_moves(self):
        ...
        with self.assertRaises(TypeError):
            your_turn(combat_details, moves)
    ...
    def test_TypeError_victory(self):
        ...
        moves = {}
        with self.assertRaises(TypeError):
            your_turn(combat_details, moves, victory="")

    def test_ValueError_moves_no_character(self):
    ...
    def test_ValueError_moves_no_board(self):
    ...
    def test_ValueError_moves_no_pokemon_inventory(self):
    ...
    def test_ValueError_moves_no_enemy_name(self):
        combat_details = {"character": 0, "board": 0, "pokemon_inventory": 0,
    ...
    def test_ValueError_moves_no_enemy_stats(self):
        combat_details = {"character": 0, "board": 0, "pokemon_inventory": 0,
    ...
    def test_ValueError_moves_no_enemy_current_pokemon(self):
        combat_details = {"character": 0, "board": 0, "pokemon_inventory": 0,
